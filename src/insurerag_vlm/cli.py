...
def main() -> None:
    ...
    import_parser = subparsers.add_parser("import-data", help="Download or register public CUAD/ACORD/InsuranceQA/official DOI/real web data sources")
    import_parser.add_argument("--output-root", type=Path, default=Path("data"))
    import_parser.add_argument(
        "--datasets",
        nargs="+",
        default=["cuad", "acord", "insuranceqa"],
        choices=["cuad", "acord", "insuranceqa", "public_docs", "state_doi_docs", "real_domain_mix"],
    )
